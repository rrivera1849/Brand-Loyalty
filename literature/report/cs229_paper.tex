...
We also calculate the following metrics for product module 5000: average unit price, average brand/store brand price ratio, and total brand/store-brand purchase ratio. The $average\ unit\ price\ =\ \frac{total\ \$\ spent}{\#units\ purchased}$. The $brand\ price\ ratio\ =\ \frac{average\ brand\ unit\ price}{average\ store\ brand\ unit\ price}$. The $brand\ purchase\ ratio\ =\ \frac{\#\ brand\ purchases}{\#\ total\ purchases}$.
